...
SECRET_KEY = 'django-insecure-69l(9jgu%otu1har$)h)uv1+h4#3g)n1&e5^647wi0a6ilvy7t'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True


ALLOWED_HOSTS = ['recipeManagementapi.herokuapp.com', 'localhost', '127.0.0.1']
...
# Configure REST framework with JWT settings
REST_FRAMEWORK = {
...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': True,                   # Whether to issue a new refresh token when refreshing the access token
